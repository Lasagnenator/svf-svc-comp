...
def main():
    ...
    runSVF(args.c_file, args.prop, args.witness, args.bits, args.claim_violations)

# Accepts a C source file, and traverses its ICFG using the SVF framework
def runSVF(input_file_path, prop_file_path, witness_file_path, bits="64", claim_violations=False):
